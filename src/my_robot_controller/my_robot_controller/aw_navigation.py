...
class CarNavigationNode(Node):
    ...
    def __init__(self):
        ...
        initial_pose.pose.pose.position.x = 3738.92
        initial_pose.pose.pose.position.y = 73732.63
              
        initial_pose.pose.pose.orientation.x = 0.0
        initial_pose.pose.pose.orientation.y = 0.0
        initial_pose.pose.pose.orientation.z = 0.23
        ...
        # Defining four different positions to reach on map 
        self.goal_poses.append({'x': 3775.583, 'y': 73726.875, 'xx': 0.0, 'yy': 0.0, 'zz': -0.517, 'w': 0.855})
        self.goal_poses.append({'x': 3771.380, 'y': 73695.671, 'xx': 0.0, 'yy': 0.0, 'zz': -0.970, 'w': 0.240})
        self.goal_poses.append({'x': 3628.072, 'y': 73665.429, 'xx': 0.0, 'yy': 0.0, 'zz': 0.721, 'w': 0.692})
        self.goal_poses.append({'x': 3722.271, 'y': 73723.929, 'xx': 0.0, 'yy': 0.0, 'zz': 0.232, 'w': 0.972})
